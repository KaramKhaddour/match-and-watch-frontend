<template>
    ...
    <div v-if="!isLoggedIn" class="login-container center-div">
        ...
        <h2 class="login-title Raleway">SignUp</h2>
        <div class="login-form-container Raleway">
            <form action="\login" class="login-form center-div" id="login-form" @submit.prevent="onSignUp()">
                
                <div class="form-group">
                    <label for="email">Name</label>
                    <input type="name" id="name"  v-model="firstName">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="surname" id="surname"  v-model="lastName">
                </div>
                ...
                <div class="login-register center-div mt-5">
                    <button type="submit" value="SUBMIT" class="register-btn button Raleway">Sign Up</button>
                </div>
        ...
        async submitForm() {
            ...
            try {
                ...
                await fetch(url, {
                    ...
                    body: JSON.stringify({'name': this.name, 'surname': this.surname, 'email': this.email, 'password': this.password})
                })
                .then((response) => {
                    if(response.ok){
